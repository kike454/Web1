...
// Crear sala pública (si el botón existe)
const createPublicRoomBtn = document.getElementById('createPublicRoom');
...
// Crear sala privada (si el botón existe)
const createPrivateRoomBtn = document.getElementById('createPrivateRoom');
